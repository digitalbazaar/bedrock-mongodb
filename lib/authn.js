...
export async function openDatabase(options) {
  ...
  // connects to the mongo server unauthenticated
  ...
  // makes an unauthenticated call on the server
  // to see if auth is required
  const authRequired = await _authRequired({config, admin});
 ...
 */
async function _authRequired({config, admin}) {
